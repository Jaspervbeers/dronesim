(HDBeetle)
Model ID: 			MDL-HDBeetle-NN-II-RGP003
				 NN = Nominal configuration (no failure)
				 II = Indoor
				 RGP = (R)atio based normalization, inversely proportional to [max_rotor_speed]^2/[max_rotor_speed + current_rotor_speed], with (G)ravity, (P)olynomial model
